...
public sealed class JwtTokenBuilder
{
    ...
    /// </summary>
    /// <returns> returns the ClaimsPrincipal object</returns>
    public ClaimsPrincipal GetPrincipalFromExpiredToken(TokenOptions tokenOptions, string token)
    {
        var validIssuer = tokenOptions.Issuer;
        var validAudience = tokenOptions.Audience;
